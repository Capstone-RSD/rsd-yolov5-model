...
_CLIENT_DAMAGELOCATION = _descriptor.Descriptor(
  name='DamageLocation',
  full_name='RSS.Client.DamageLocation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lat_lng', full_name='RSS.Client.DamageLocation.lat_lng', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='RSS.Client.DamageLocation.address', index=1,
...
_CLIENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='speed', full_name='RSS.Client.speed', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blobs', full_name='RSS.Client.blobs', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blob_map', full_name='RSS.Client.blob_map', index=5,
  ...
  nested_types=[_CLIENT_DAMAGELOCATION, _CLIENT_BLOBMAPENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CLIENT_DAMAGELOCATION.fields_by_name['lat_lng'].message_type = google_dot_type_dot_latlng__pb2._LATLNG
_CLIENT_DAMAGELOCATION.fields_by_name['address'].message_type = google_dot_type_dot_postal__address__pb2._POSTALADDRESS
_CLIENT_DAMAGELOCATION.containing_type = _CLIENT
...
Client = _reflection.GeneratedProtocolMessageType('Client', (_message.Message,), dict(
  ...
  DamageLocation = _reflection.GeneratedProtocolMessageType('DamageLocation', (_message.Message,), dict(
    DESCRIPTOR = _CLIENT_DAMAGELOCATION,
    __module__ = 'rss_client_pb2'
    # @@protoc_insertion_point(class_scope:RSS.Client.DamageLocation)
    ))
  ,

  BlobMapEntry = _reflection.GeneratedProtocolMessageType('BlobMapEntry', (_message.Message,), dict(
...
_sym_db.RegisterMessage(Client.DamageLocation)
_sym_db.RegisterMessage(Client.BlobMapEntry)

BlobSrc = _reflection.GeneratedProtocolMessageType('BlobSrc', (_message.Message,), dict(
  DESCRIPTOR = _BLOBSRC,
  __module__ = 'rss_client_pb2'
